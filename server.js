...
app.delete("/notes/:id", function(req, res) {
  ...
  db.Note.deleteOne({ _id: req.params.id })
    // ..and delete all of the notes associated with it
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.atlasnetwork.org/news?gclid=EAIaIQobChMI8O-8y-ig4QIVwmSGCh04pw2JEAAYASAAEgIvx_D_BwE").then(function(response) {
    ...
    $("article").each(function(i, element) {
      ...
      result.image = $(this).find('img') 
      result.title = $(this).find(".articleHeader").text();
      result.blurb = $(this).find(".articleText").text();
      result.link = $(this).find(".articleHeader")
        .find("a")
        .attr("href"); 
